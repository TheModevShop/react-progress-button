...
var ProgressButton = _react2['default'].createClass({
  ...
  render: function render() {
    return _react2['default'].createElement(
      ...
      { className: this.props.classNamespace + "container " + this.state.currentState, onTap: !this.props.disabled ? this.handleClick : null },
      _react2['default'].createElement("button", { disabled: this.props.disabled, type: this.props.type, form: this.props.form,
